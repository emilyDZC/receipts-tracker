        ...
        <div>
          ...
          <div class="space-y-2 sm:space-y-0 sm:grid sm:grid-cols-[1fr_auto_auto] sm:gap-2">
            ...
            <input
              ...
              type="text"
              required
              placeholder="eg. your home address"
       ...
       <div>
          ...
          <div class="space-y-2 sm:space-y-0 sm:grid sm:grid-cols-[1fr_auto_auto] sm:gap-2">
            <input
              ...
              type="text"
              required
              placeholder="e.g. Gas Street, Birmingham"
              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Work Details (optional)</label>
          <input
            v-model="work"
            type="text"
            placeholder="eg. Viva rehearsal"
            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
        </div>
